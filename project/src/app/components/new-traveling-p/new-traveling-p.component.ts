...
//       {
//       swal({
//         title: "הזנת תאריך התחלה הקודם לתאריך היום ",
//         icon: "error"
//       });
//     }
//    if (this.traveling.ToDate < this.traveling.FromDate) {
//       swal({
//         title: "הזנת תאריך סיום הקודם לתאריך התחלה ",
//         icon: "error"
//       });
//     }
// if( (this.traveling.FromDate < new Date(Date.now())  && !isToday ) || (this.traveling.ToDate.getDate < this.traveling.FromDate.getDate))
//       {
//       swal({
...
//     {
      ...
      this.serviceTravelingPassenger.addTraveling(this.traveling)
        .subscribe(idTravelingP => this.roter.navigate(['/suitable-drivers/' + idTravelingP]));
    // }
  }
